...
public class EmailService {
    ...
    public void sendSimpleMessage(String to, String subject, String text, List<String> listOfEmailsToSend){
        ...
        message.setFrom("jihed.makthri@gmail.com");
        message.setTo(to);
    ...
    public void forgotPasswordMail(String to,String subject,String password) throws MessagingException{
        ...
        helper.setFrom("jihed.makthri@gmail.com");
        helper.setTo(to);
        helper.setSubject(subject);
        String htmlMessage = "<p><b>Your Login details for Connect4Aid Account</b><br><b>Email: </b> " + to + " <br><b>Password: </b> " + password + "<br><a href=\"http://localhost:4200/\">Click here to login</a></p>";
